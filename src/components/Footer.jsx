const socials = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/coderamaan',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/amaanahmedcoder',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-slate-950 text-slate-400 py-8 px-4">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-semibold text-white text-sm">MERN Auth</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          {socials.map(({ label, href, icon, hover }) => (
            <a
              ...
              aria-label={label}
              className={`text-slate-500 transition-colors duration-200 ${hover}`}
            >
              {icon}
            </a>
          ))}
